...
public class Exercise13UpsertTest {
    ...
    public void shouldOnlyInsertDBObjectIfItDidNotExistWhenUpsertIsTrue() {
        ...
        WriteResult resultOfUpdate = collection.update(findClaire, new BasicDBObject("$set", new BasicDBObject("wasUpdated", true)));
        ...
        // When
        WriteResult resultOfUpsert = collection.update(findClaire, new BasicDBObject("$set", new BasicDBObject("wasUpdated", true)), true, false);
    ...
    @Before
    public void setUp() throws UnknownHostException, UnknownHostException {
